...
local pluginCount = {
	type = "text",
	val = string.format("Neovim %s " .. lvim.icons.kind.Module .. " %d plugins in total.", print_version, plugins),
...
local buttons = {
	...
	val = {
		...
		button(
			{ shortcut = "q", hl = { { "Error", 2, 3 } } },
			lvim.icons.diagnostics.Error .. " Quit Neovim",
			":qa<CR>"
		),
		{ type = "padding", val = 2 },
		{ type = "padding", val = 2 },
